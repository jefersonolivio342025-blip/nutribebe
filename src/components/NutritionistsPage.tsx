    ...
    <div className="page-container">
      ...
      {!isPremium && (
        <div className="relative">
          {/* Google Maps Button - Locked */}
          <div className="relative mb-6">
            <div className="flex items-center justify-center gap-2 w-full py-4 rounded-2xl bg-gradient-to-r from-muted to-muted-foreground/20 text-muted-foreground font-bold text-base cursor-not-allowed">
              <Lock size={20} />
